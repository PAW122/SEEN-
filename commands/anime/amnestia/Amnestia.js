...
module.exports = {
    ...
    execute: async(message, args) =>  {
        ...
        const rng = Math.floor(Math.random() * 4);//od 1 do 4
        ...
        const attachment = new MessageAttachment(`commands/anime/amnestia/grafika/amnesia${rng}${roz}`)

        message.channel.send(`Grafika Nr:${rng}/4\n Anime:Amnesia`);
