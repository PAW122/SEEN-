...
module.exports = {
    ...
    execute: async(message, args) =>  {
        ...
        const rng = Math.floor(Math.random() * 23);//od 1 do 23
        ...
        const attachment = new MessageAttachment(`commands/anime/konata/grafikakonata/konata${rng}${roz}`)

        message.channel.send(`Grafika Nr:${rng}/23\n Anime:Lucky Star`);
